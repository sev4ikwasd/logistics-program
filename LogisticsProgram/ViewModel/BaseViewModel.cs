...
namespace LogisticsProgram
{
    ...
    {
        private readonly Dictionary<string, PropertyWithErrorsList> propErrors =
            new Dictionary<string, PropertyWithErrorsList>();
        ...
        protected override void OnPropertyChanged(PropertyChangedEventArgs args)
        {
            ...
            if (args.PropertyName != "HasErrors") Validate();
        }

        protected abstract void Validate();

        protected void ValidateProperty(string propertyName, object property,
            Func<PropertyWithErrorsList, PropertyWithErrorsList> check)
        {
